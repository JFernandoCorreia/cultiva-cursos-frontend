  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="bg-recifeBlue text-white px-4 py-2 mt-4 rounded-lg w-full transition-all duration-300 hover:bg-recifeGold hover:text-recifeBlue focus:outline-none focus:ring-2 focus:ring-green-400"
